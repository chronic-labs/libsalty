...
SALTY_CONST_INT64(pwhash_argon2i_SALTBYTES);
SALTY_CONST_INT64(pwhash_argon2id_STRBYTES);
SALTY_CONST_INT64(pwhash_argon2i_STRBYTES);
SALTY_CONST_INT64(pwhash_argon2id_OPSLIMIT_MIN);
SALTY_CONST_INT64(pwhash_argon2id_OPSLIMIT_MAX);
SALTY_CONST_INT64(pwhash_argon2i_OPSLIMIT_MIN);
SALTY_CONST_INT64(pwhash_argon2i_OPSLIMIT_MAX);
SALTY_CONST_INT64(pwhash_argon2id_OPSLIMIT_INTERACTIVE);
SALTY_CONST_INT64(pwhash_argon2id_MEMLIMIT_INTERACTIVE);
SALTY_CONST_INT64(pwhash_argon2i_OPSLIMIT_INTERACTIVE);
SALTY_CONST_INT64(pwhash_argon2i_MEMLIMIT_INTERACTIVE);
SALTY_CONST_INT64(pwhash_argon2id_OPSLIMIT_MODERATE);
SALTY_CONST_INT64(pwhash_argon2id_MEMLIMIT_MODERATE);
SALTY_CONST_INT64(pwhash_argon2i_OPSLIMIT_MODERATE);
SALTY_CONST_INT64(pwhash_argon2i_MEMLIMIT_MODERATE);
SALTY_CONST_INT64(pwhash_argon2id_OPSLIMIT_SENSITIVE);
SALTY_CONST_INT64(pwhash_argon2id_MEMLIMIT_SENSITIVE);
SALTY_CONST_INT64(pwhash_argon2i_OPSLIMIT_SENSITIVE);
SALTY_CONST_INT64(pwhash_argon2i_MEMLIMIT_SENSITIVE);
...
SALTY_FUNC(pwhash_str, 3) DO
    ...
    SALTY_CALL(crypto_pwhash_str(
                   (char *) hash.data, (const char *) password.data, password.size,
                   opslimit, memlimit),
               hash);
END_OK_WITH(hash);

SALTY_FUNC(pwhash_str_alg, 4) DO
    SALTY_INPUT_BIN(0, password, crypto_pwhash_argon2id_PASSWD_MIN);
    SALTY_INPUT_UINT64(1, opslimit);
    SALTY_INPUT_UINT64(2, memlimit);
    SALTY_INPUT_UINT64(3, alg);

    SALTY_OUTPUT_BIN(hash, crypto_pwhash_argon2i_STRBYTES);

    SALTY_CALL(crypto_pwhash_str_alg(
                   (char *) hash.data, (const char *) password.data, password.size,
...
salty_exports[] = {
    ...
    SALTY_EXPORT_CONS(pwhash_argon2i_SALTBYTES, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_OPSLIMIT_MIN, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_OPSLIMIT_MAX, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_OPSLIMIT_MIN, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_OPSLIMIT_MAX, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_OPSLIMIT_INTERACTIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_MEMLIMIT_INTERACTIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_OPSLIMIT_INTERACTIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_MEMLIMIT_INTERACTIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_OPSLIMIT_MODERATE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_MEMLIMIT_MODERATE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_OPSLIMIT_MODERATE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_MEMLIMIT_MODERATE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_OPSLIMIT_SENSITIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_MEMLIMIT_SENSITIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_OPSLIMIT_SENSITIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_MEMLIMIT_SENSITIVE, 0),
    SALTY_EXPORT_CONS(pwhash_argon2id_STRBYTES, 0),
    SALTY_EXPORT_CONS(pwhash_argon2i_STRBYTES, 0),
